        ...
        <div
          ...
          className={`
            ...
            ${isDragActive || isDragOver
              ? 'border-emerald-500 bg-emerald-50 scale-[1.01] cursor-copy'
              : uploading
                ? 'border-gray-200 bg-gray-50 cursor-not-allowed'
                : 'border-gray-200 bg-white hover:border-emerald-400 hover:bg-emerald-50/20 cursor-pointer'}
          `}
        >
          <input {...getInputProps()} />
          ...
          <div className="p-8 sm:p-12 flex flex-col items-center text-center">
            {uploading ? (
              ...
              <>
                ...
                <p className="text-base font-semibold text-gray-800 mb-1">{t('upload.dropHere')}</p>
                <p className="text-sm text-gray-400 mb-6">{t('upload.orBrowse')}</p>
                ...
                <div className="flex gap-3 flex-wrap justify-center mb-6">
                  <div
                    ...
                    className="contents"
                  >
                    <label className="flex items-center gap-2 px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-semibold rounded-xl cursor-pointer shadow-sm shadow-emerald-200 transition-all hover:scale-105 active:scale-95">
                      <input
                        type="file"
