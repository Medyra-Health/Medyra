...
export const metadata = {
  ...
  keywords: [
    ...
    'Laborwert Checker',
    'lab value checker',
    'blood values normal range',
    'Blutwerte prüfen',
    'Medikationsplan verstehen',
    'medication plan explained',
    'prescription explained AI',
    'Rezept verstehen',
    'Entlassungsbericht verstehen',
    'hospital discharge report explained',
    'Krankenkassen Brief verstehen',
    'health insurance letter explained',
    'Befunddolmetscher',
    'MCHC Wert',
    'medical lexikon',
    'Laborwerte Lexikon',
