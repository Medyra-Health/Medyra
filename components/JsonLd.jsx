    ...
    '@graph': [
      ...
      },
      {
        ...
        featureList: [
          ...
          'Free medication plan (Medikationsplan) in the German 1-0-1-0 scheme',
          'Day, week and month medication planning with adherence tracking',
          'Medication reminders by calendar export and email',
          'Printable medication plan',
          'Medical lexicon covering 138 lab values in 17 languages',
          ...
          'Health profiles for family members',
          'Longitudinal biomarker tracking over time',
