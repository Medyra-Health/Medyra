        ...
        offers: [
          {
            '@type': 'Offer',
            name: 'Free',
            description: '1 medical report per month at no cost',
            price: '0',
            priceCurrency: 'EUR',
          ...
          },
          {
            '@type': 'Offer',
            name: 'One-Time',
            description: 'Single report analysis with follow-up chat',
            price: '4.99',
            priceCurrency: 'EUR',
            availability: 'https://schema.org/InStock',
          },
          {
            '@type': 'Offer',
            name: 'Personal',
            description: 'Unlimited reports per month',
            price: '9.00',
            priceCurrency: 'EUR',
            availability: 'https://schema.org/InStock',
          },
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Medyra offers a free plan (1 report/month), a one-time option (€4.99/report), and monthly subscriptions starting at €9/month for unlimited reports. No credit card required to start.',
            },
          },
          {
            '@type': 'Question',
